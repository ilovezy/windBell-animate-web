    ...
    <el-dialog
      ...
      <div class="protocol-body">
        <div class="protocol-info protocal-main">
          <p> 尊敬的客户：</p>
          <p class='indent2'>以上日发金融为平台的期货授信业务是一种潜在收益和潜在风险较 高的投资品种，对客
            户理解风险的能力、控制风险的能力、承受风险的能力以及投资经验 都有较高的要求。客户
            签署本协议书，代表对日发金融业务的风险已有充分的认知及了 解。</p>
          ...
          <p>若客户对于本揭示书有不理解或不清晰的地方，应该及时向日发金融咨询相关信息， 对
            揭示书不存在任何异议时，请亲自确认</p>
          <p>一、温馨提示</p>
          ...
          <p>2. 日发金融与现有的期货投资交易市场相比，在交易模式、交易规则等方面完全一致，港
            唯国际为了确保市场“公开、公平、公正”和健康稳定地发展，将采取更加严格的措施以
            强化市场的监管。请客户务必密切关注日发金融的公告、风险提示等信息，及时了解市场 风
            险状况，做到理性投资，切忌盲目跟风。
          </p>
          <p>3. 客户在开通交易之前，请配合日发金融完成客户的适当性管理工作，完整、如实地提供
